...
async function init() {
    ...
    const contactListener = new ContactListener(metaData, clientIds, players, starInfo);
...
function physicsLoop() {
    ...
    for (let i = 0; i < starBodies.length; i++) {
        ...
        starInfo[i].position.x = b.GetPosition().x * pixelsPerMeter;
        starInfo[i].position.y = b.GetPosition().y * pixelsPerMeter;
    }
