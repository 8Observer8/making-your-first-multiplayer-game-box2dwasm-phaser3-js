...
async function init() {
    ...
    for (let i = 0; i < 12; i++) {
        ...
        const starPosX = starX / pixelsPerMeter;
        const starPosY = 0;
        bodyDef.set_position(new b2Vec2(starPosX, starPosY));
        const body = world.CreateBody(bodyDef);
        ...
        starInfo.push({ id: starId, visible: true, position: { x: starPosX, y: starPosY } });
        metaData[getPointer(fixture)] = {
            id: starId,
            type: 'star',
            starPosX: starPosX,
    ...
    const contactListener = new ContactListener(metaData, clientIds, starInfo);
